    ...
    return (
        <div className="relative w-full">
            ...
            <div className=" flex justify-center -mt-24 w-full">
                <div
                    className="w-full rounded-[24px] p-[15px] flex flex-col xl:flex-row pr-3 bg-[#FAFAFC] sm:bg-white">
                    {/* Left section */ }
                    <div
                        className="relative sm:mb-4 xl:mb-0 xl:flex xl:flex-col xl:items-center md:text-left md:items-start 2xl:w-[248px]">
                        <Image
                            src={ profile }
                            alt="Profile"
                            width={ 152 }
                            height={ 152 }
                            className="mb-4 mx-auto -mt-20"
                        />
                        <div className="sm:hidden w-full">
                            <Title/>
                        </div>
                        <div className="bg-white py-4 px-3.5 rounded-[24px] sm:hidden min-w-80">
                            <Rating/>
                        </div>
                        <div
                            className="w-full z-0 mt-2.5 py-3.5 px-4 sm:border sm:border-[#F1F3F9] rounded-[24px] sm:pt-5 sm:pb-2.5 sm:px-3 bg-white xl:w-[248px] 2xl:w-[248px]">
                            ...
                            <div className="xl:hidden space-y-[8px] text-[#202020] font-bold text-[12px] lg:text-base">
                                <div className="flex justify-between">
                                    ...
                                    <div className="flex items-center mb-[8px]">
                                        <Image className="mr-1.5" src={ global } alt="global" width={ 28 }
                                               height={ 28 }/>
                                        <p>RUS, UZ, ENG</p>
                                    </div>
                                </div>
                                <div className="flex justify-between">
                                    <div className="flex items-center mb-[8px]">
                                        <Image className="mr-1.5" src={ location } alt="location" width={ 28 }
                                               height={ 28 }/>
                                        <p>Uzbekistan</p>
                                    </div>
                                    <div className="flex items-center mb-[8px]">
                                        <Image className="mr-1.5" src={ phone } alt="phone" width={ 28 } height={ 28 }/>
                                        <p>Phone confirmed</p>
                                    </div>
                                </div>
                                <div className="flex items-center font-bold">
                            ...
                            <div
                                className="w-full mt-2.5 sm:mt-[27px] flex justify-center md:justify-start bg-[#FAFAFC] rounded-[100px]">
                                <button className="w-1/2 px-[24px] py-[10px] text-[#9CA5B3] rounded flex items-center gap-1.5 justify-center">
                                    <Image src={ briefcase } alt="briefcase" width={ 16 }
                                           height={ 16 }/>
                                    <p>Client</p>
                                </button>
                                <button
                                    className="w-1/2 px-[24px] py-[10px] text-[#9CA5B3] rounded-[100px] bg-[#EDF4FF] border border-solid border-[#F2F2F2] gap-1.5 flex items-center justify-center">
                                    <Image src={ brush } alt="briefcase" width={ 16 }
                                           height={ 16 }/>
                    ...
                    {/* Right section */ }
                    <div
                        className="pb-5 rounded-[12px] px-5 xl:px-5 2xl:px-0 sm:mr-4 2xl:mr-10 2xl:ml-7 bg-white w-full">
                        ...
                        <div className='rounded-[16px]'>
                            ...
                            <div className='sm:mb-[24px]'>
                                ...
                                <div className="flex flex-wrap gap-1 sm:gap-2 text-[12px] sm:text-[14px] ">
                                    <span
                                        className="px-[12.5px] py-[10.5px] border border-solid border-[#F2F2F2] rounded-full">Bitrix24</span>
                                    <span
